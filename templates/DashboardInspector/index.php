                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge badge-<?=
                                                                            $inspection->status === 'completed' ? 'success' : ($inspection->status === 'scheduled' ? 'warning' : ($inspection->status === 'ongoing' ? 'info' : 'secondary'))
                                                                            ?> badge-sm">
                                            ...
                                            <td>
                                                <span class="badge badge-<?=
                                                                            ($inspection->client->risk_level ?? 'low') === 'high' ? 'danger' : (($inspection->client->risk_level ?? 'low') === 'medium' ? 'warning' : 'success')
                                                                            ?> badge-sm">
